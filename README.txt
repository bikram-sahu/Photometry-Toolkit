...
To begin with, please install the following python modules (if not present):
	1. pyfits
	2. scipy
	3. datetime
	4. mpl_toolkits
...
######## TO GET 3D PLOTS OF ALL THE OBJECTS IN OUR FRAME UNDER CONSIDERATION #########

1. After completion of the above mandatory procedure, go to the "Crop" directory.

2. Execute 3d_profiles.py
